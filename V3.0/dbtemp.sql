...
CREATE TABLE IF NOT EXISTS dbtemp.tblklimawert(kwid INT PRIMARY KEY NOT NULL AUTO_INCREMENT, temp DOUBLE, lfeuchte DOUBLE, druck DOUBLE, ppmco2 DOUBLE, zeitpunkt DATETIME, fksensid INT, FOREIGN KEY(fksensid) REFERENCES dbtblklimawerttemp.tblsensor(sensid) );*/
